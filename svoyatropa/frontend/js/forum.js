...
function loadForumData() {
    const saved = localStorage.getItem('svoyatropa_forum') || localStorage.getItem('yaturist_forum_data');
    if (saved) {
        try {
...
function saveForumData() {
    localStorage.setItem('svoyatropa_forum', JSON.stringify(forumData));
