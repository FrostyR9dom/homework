...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadUserRoutes(currentUser) {
        ...
        var allRoutes = JSON.parse(localStorage.getItem('svoyatropa_routes') || localStorage.getItem('yatyrist_routes') || '[]');
    ...
    if (settingsForm) {
        settingsForm.addEventListener('submit', function(e) {
            ...
            if (typeof updateUserData === 'function') {
                ...
                localStorage.setItem('svoyatropa_user', JSON.stringify(currentUser));
                localStorage.setItem('yaturist_user', JSON.stringify(currentUser));
        ...
        if (uploadBtn && photoInput) {
            uploadBtn.addEventListener('click', function() {
                ...
                reader.onload = function(e) {
                    let gallery = JSON.parse(localStorage.getItem('svoyatropa_gallery') || localStorage.getItem('yaturist_gallery') || '[]');
                    ...
                    localStorage.setItem('svoyatropa_gallery', JSON.stringify(gallery));
    ...
    function renderForum() {
        let threads = JSON.parse(localStorage.getItem('svoyatropa_forum') || localStorage.getItem('yaturist_forum') || '[]');
    ...
    window.openThreadDetail = function(threadId) {
        ...
        localStorage.setItem('svoyatropa_forum', JSON.stringify(threads));
        localStorage.setItem('yaturist_forum', JSON.stringify(threads));
        renderForum();
...
function deleteRoute(id) {
    if (confirm('Удалить маршрут?')) {
        ...
        localStorage.setItem('svoyatropa_routes', JSON.stringify(newRoutes));
