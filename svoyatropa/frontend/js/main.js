...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addPhotoToGallery(url, rating) {
        ...
        localStorage.setItem('svoyatropa_gallery', JSON.stringify(photos));
        localStorage.setItem('yaturist_gallery', JSON.stringify(photos));
    }

    function getGalleryPhotos() {
        var photos = localStorage.getItem('svoyatropa_gallery') || localStorage.getItem('yaturist_gallery');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addForumTopic(title, content) {
        ...
        localStorage.setItem('svoyatropa_forum', JSON.stringify(topics));
        localStorage.setItem('yaturist_forum', JSON.stringify(topics));
    }

    function getForumTopics() {
        var topics = localStorage.getItem('svoyatropa_forum') || localStorage.getItem('yaturist_forum');
