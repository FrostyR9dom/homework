...
function getAllRoutes() {
    var routesJson = localStorage.getItem('svoyatropa_routes') || localStorage.getItem('yatyrist_routes');
    ...
    if (routes.length === 0) {
        ...
        localStorage.setItem('svoyatropa_routes', JSON.stringify(routes));
        localStorage.setItem('svoyatropa_routes', JSON.stringify(routes));
...
function cleanDemoRoutes() {
    ...
    if (filteredRoutes.length !== allRoutes.length) {
        localStorage.setItem('svoyatropa_routes', JSON.stringify(filteredRoutes));
