...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadRouteForEditing(id) {
        let allRoutes = JSON.parse(localStorage.getItem('svoyatropa_routes') || localStorage.getItem('yatyrist_routes') || '[]');
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            if (editMode) {
                ...
                localStorage.setItem('svoyatropa_routes', JSON.stringify(allRoutes));
                ...
                let routesFromStorage = localStorage.getItem('svoyatropa_routes') || localStorage.getItem('yatyrist_routes');
